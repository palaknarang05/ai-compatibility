    ...
    children: [!disableLine && (0, import_jsx_runtime3.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime3.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime3.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime3.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime5.jsxs)(React8.Fragment, {
      children: [isBandScaleY && yScale(value) !== void 0 && (0, import_jsx_runtime5.jsx)(ChartsAxisHighlightPath, {
      ...
      }), type === "line" && value !== null && (0, import_jsx_runtime5.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime6.jsxs)(React9.Fragment, {
      children: [isBandScaleX && xScale(value) !== void 0 && (0, import_jsx_runtime6.jsx)(
      ...
      ), type === "line" && value !== null && (0, import_jsx_runtime6.jsx)(ChartsAxisHighlightPath, {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(React13.Fragment, {
    children: yTicks.map(({
      value,
      offset
...
//# sourceMappingURL=chunk-TPI6RNA7.js.map
