...
public interface ScanMetricsService {
    @SystemMessage("""
      ...
      - Strictly avoid markdown responses, only output json with keys in strict camel case with no special(including escape) characters.
      ...
      """)
    ScanMetrics answer(@UserMessage String query);
}